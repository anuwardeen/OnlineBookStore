...
#################################################################################################################
    ...
    def creating_records(self,no_of_authors ,no_of_books,last_author_id):
        ...
        for i in range(no_of_authors):
            new_author=Author(author_id=author_id_starts_from,author_name="Author"+str(i),author_email_id='a@b.com',date_of_birth='1992-12-12',blog='www.google.com',total_books_sold=0)
